...
const routes: Routes = [
  ...
  { path: 'transactions/new', component: TransactionsNewComponent, canLoad: [UserOnlyGuard], children: [
    ...
    { path: 'rates', component: RatesConverterComponent },
    { path: 'data', component: NotFoundComponent },
    { path: 'recipient', component: TransactionsAddRecipientsComponent },
    { path: 'overview', component: NotFoundComponent },
  ]},
